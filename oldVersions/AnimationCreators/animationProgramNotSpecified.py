...
def getIterationArray(iterationIndex):              #returns a 2D array with Index,Pinky and thumbData
    ...
    while pd.isnull(nextIteration) == False:             #While the value in the Excel collumn is not Nan, reads from top to bottom
        ...
        nextIteration = list_data[increaseIndex+1][iterationIndex]        #Checks if next value is null
...
filePath = '2ndList.xlsx'                   # this is the file path of the Excel sheet
sheet=3                                     # Usually 2
...
if(os.path.exists(filePath)):
    ...
    xl = pd.ExcelFile(filePath)
      ...
      # see all sheet names
    print("Working with sheet: "+ xl.sheet_names[sheet])
    ...
    print(f"The file path {filePath} does not exist, in program error")    
    exit()
