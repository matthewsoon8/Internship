...
"""
    ...
    the COP is at any point in time. This is the final version of the GUI. 2 buttons added
"""
...
root.title('Point Plotting system')
state = ''
...
def graphPage():
    ...
    skipForwardButton.place(x=820, y=250, width=150)
    
    nextButton = tk.Button(currentFrame, text='Next time interval', font=('Bold', 12),
                           bg='#158aff', fg='white',command=lambda number=1: increaseIndex(number) )
    nextButton.place(x=820, y=300, width=150)
    ...
    skipBackwardButton.place(x=650, y=250, width=150)

    previousButton = tk.Button(currentFrame, text='Previous time interval', font=('Bold', 12),
                               bg='#158aff', fg='white', command=lambda number=1: decreaseIndex(number) )
    previousButton.place(x=650, y=300, width=150)
    ...
    nextDataPoint = tk.Button(currentFrame, text='test button', font=('Bold', 12),
                           bg='#158aff', fg='white' )
    nextDataPoint.place(x=820, y=60, width=150)
    previousDataPoint = tk.Button(currentFrame, text='left button', font=('Bold', 12),
                           bg='#158aff', fg='white' )
    previousDataPoint.place(x=650, y=60, width=150)
